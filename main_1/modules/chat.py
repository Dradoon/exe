...
def QaA(Q):
    ...
    while True:
        ...
        #creating a new dict{} of question with answer asked to the user
            ...
            print("Should I check on wikipedia")
            option=input("yes/no: ")
            if option.lower()=="yes":
                return "use_wiki"            
            elif rand==1:read=("Oh! I don't know the answer for this could you tell me please.")
            ...
            elif rand==5:read=("This is a new statment for me could you tell me the answer.")
            print(read)            
            new_Q=Q
            new_A=input()
            new=[new_Q,new_A]
